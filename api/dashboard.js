...
<div class="top"><h1>MINION TICKETS</h1><div><span class="sync-status" id="sync-status"></span><button class="badge sync" id="sync-inbox" type="button">Sync inbox</button> <a class="badge" href="/monthly" style="text-decoration:none">Monthly &amp; Orders</a> <a class="badge" href="/pnl" style="text-decoration:none">P&amp;L</a> <a class="badge" href="/costs" style="text-decoration:none">Costs</a></div></div>
